...
class document
{
    ...
    public static function Add($date_doc,$name_doc,$file_doc)
    { 
       require("connection_connect.php");
       $sql = "INSERT INTO `document` (`id_doc`, `date_doc`, `name_doc`, `file_doc`) 
       VALUES (NULL, '$date_doc', '$name_doc', '$file_doc')";
       $result = $conn->query($sql);
       require("connection_close.php");
       return  ;
    }
    public static function get($id)
    {
        ...
        $id_doc = $my_row['id_doc'];
            ...
            $file_doc = $my_row['file_doc'];
        require("connection_close.php");
        return new document($id_doc,$date_doc,$name_doc,$file_doc);

    }
    public static function update2($date_doc,$name_doc,$file_doc,$id_doc)
    {
       require("connection_connect.php");
       $sql="UPDATE `document` SET `date_doc`='$date_doc',
       `name_doc`='$name_doc',`file_doc`='$file_doc' WHERE id_doc = '$id_doc'";
       $result=$conn->query($sql);
       require("connection_close.php");
       return ;
    }
    public static function update($date_doc,$name_doc,$id_doc)
    {
       require("connection_connect.php");
       $sql="UPDATE `document` SET `date_doc`='$date_doc',
       `name_doc`='$name_doc' WHERE id_doc = '$id_doc'";
       $result=$conn->query($sql);
       require("connection_close.php");
       return ;
    }
