...
class workplace
{
    public $id_workp,$name_workp,$detail_workp,$money_workp,$add_workp;

    public function __construct($id_workp,$name_workp,$detail_workp,$money_workp,$add_workp)
    {
        $this->id_workp= $id_workp;
        $this->name_workp= $name_workp;
        $this->detail_workp= $detail_workp;
        $this->money_workp= $money_workp;
        $this->add_workp= $add_workp;
    }
    ...
    public static function getAll()
    {
        ...
        while ($my_row = $result->fetch_assoc()) {
            ...
            $add_workp = $my_row['add_workp'];

            $workplaceList[] = new workplace($id_workp,$name_workp,$detail_workp,$money_workp,$add_workp);
        }
    ...
    public static function get($id)
    {
        ...
        $add_workp = $my_row['add_workp'];
        require("connection_close.php");
        return new workplace($id_workp,$name_workp,$detail_workp,$money_workp,$add_workp);

    }
    public static function update($name_workp,$detail_workp,$money_workp,$add_workp,$oldid)
    {
       require("connection_connect.php");
       $sql="UPDATE `workplace` SET `name_workp`='$name_workp',
       `detail_workp`='$detail_workp',`money_workp`='$money_workp',`add_workp`='$add_workp' WHERE id_workp = '$oldid'";
       $result=$conn->query($sql);
       require("connection_close.php");
       return ;
    }
    ...
    public static function Add($name_workp,$detail_workp,$money_workp,$add_workp)
    { 
       require("connection_connect.php");
       $sql = "INSERT INTO `workplace` (`id_workp`, `name_workp`, `detail_workp`, `money_workp`, `add_workp`) 
       VALUES (NULL, '$name_workp', '$detail_workp', '$money_workp', '$add_workp')";
       $result = $conn->query($sql);
       require("connection_close.php");
       return  ;
    }
