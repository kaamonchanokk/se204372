...
class news
{
    ...
    public static function Add($date_news,$name_news,$file_news,$detail_news)
    { 
       require("connection_connect.php");
       $sql = "INSERT INTO `news` (`id_news`, `date_news`, `name_news`, `file_news`, `detail_news`) 
       VALUES (NULL, '$date_news', '$name_news', '$file_news', '$detail_news')";
       $result = $conn->query($sql);
       require("connection_close.php");
       return  ;
    }
    public static function get($id)
    {
        ...
        require("connection_close.php");
        return new news($id_news,$date_news,$name_news,$file_news,$detail_news);

    }
    public static function update2($date_news,$name_news,$file_news,$detail_news,$id_news)
    {
       require("connection_connect.php");
       $sql="UPDATE `news` SET `date_news`='$date_news',
       `name_news`='$name_news',`file_news`='$file_news',`detail_news`='$detail_news' WHERE id_news = '$id_news'";
       $result=$conn->query($sql);
       require("connection_close.php");
       return ;
    }
    public static function update($date_news,$name_news,$detail_news,$id_news)
    {
       require("connection_connect.php");
       $sql="UPDATE `news` SET `date_news`='$date_news',
       `name_news`='$name_news',`detail_news`='$detail_news' WHERE id_news = '$id_news'";
       $result=$conn->query($sql);
       require("connection_close.php");
       return ;
    }
