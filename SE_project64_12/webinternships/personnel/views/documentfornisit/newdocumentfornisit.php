...
<br>
<center>
<form method="POST" action="?controller=documentfornisit&action=adddocumentfornisit" enctype="multipart/form-data" >
<div class="block-1">
<br>
  <h2 style="position: relative;left:50px">อัพโหลดเอกสารสำหรับนิสิต</h2>
  <br>

    <div class="row">
        <div class="col">
            <div class="col-25" style="position: relative;left:50px">วันที่อัพโหลด</div>
            <div class="col-75"><p name="date_docnisit"style="position: relative;left:50px"><?php echo date("Y-m-d"); ?><p>
            <input name="date_docnisit" type="hidden" value="<?php echo date("Y-m-d"); ?>">   </div>
        </div>
        <div class="col">
            <div class="col-25" style="position: relative;left:50px">รหัสนิสิต</div>
              <div class="col-75" style="position: relative;left:50px">
                                <select name="id_nisit" style="width:500px">
                                <?php foreach($studentList as $s) {echo "<option value = $s->student_id>
                                $s->student_id $s->student_name</option>";}?>
                                </select>
                              </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col">
            ...
            <div class="col-75"><input type="text" name="name_docnisit" style="position: relative;left:50px" required/></div><br>
        </div>
        <div class="col">
            <div class="col-25" style="position: relative;left:50px">อัพโหลดเอกสาร(.pdf)</div>
            <div class="col-75"><input type="file" name="file_docnisit" value="" style="position: relative;left:50px" required/></div><br>
        </div>
    </div>
        <div class="row">
            <div class="col">
              ...
              <center>
              <button type="submit" class = "btn btn-primary btn-lg"  style="position: relative;top:25px" name="action" value="addintrequest" >ยืนยัน</button>
              </center>
            </div>
          </div>
          <br>
