...
<div class="block-1">
<br>
  <h2 style="position: relative;left:50px">ออกเอกสาร</h2>
  <br>
  <table border = 1>
<tr> 
<th>วันที่อัพโหลด</th>
  ...
  foreach($documentfornisitList as $documentfornisitList)
{
    ...
    ?>
    <td><form method="POST" action="?controller=documentfornisit&action=delete">
      <input name="_method" type="hidden" value="DELETE">
      <input name="id_docnisit" type="hidden" value="<?php echo "$documentfornisitList->id_docnisit";?>">
      <button type="button" class="btn btn-xs btn-danger btn-flat show_confirm" data-toggle="tooltip" test="<?php echo "$documentfornisitList->id_nisit $documentfornisitList->name_docnisit";?>" title='Delete'>🗑️</button>
      </form></td>
</tr>
    <?php
}
echo "</table>";
?>
<a class="btn btn-primary btn-xs" style="float:right;position: relative;right:200px" href=?controller=documentfornisit&action=newdocumentfornisit>เพิ่มข้อมูล</a><br>
<br>
<br>
<br>
<br>
