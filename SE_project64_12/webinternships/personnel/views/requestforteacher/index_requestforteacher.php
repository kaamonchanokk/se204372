  ...
  foreach($Requestforteacherlist as $Requestforteacherlist)
{
    ...
    <td>
        <form method="POST" action="?controller=requestforteacher&action=updatestatus">
            ...
            <button type="button" class="btn btn-xs btn-success btn-flat show_confirm" data-toggle="tooltip" test="อนุมัติ" test2="<?php echo "$Requestforteacherlist->student_name" ;?>"  title='Delete'>อนุมัติ</button>
        </form>
    </td>
    ...
    <td>
        <form method="POST" action="?controller=requestforteacher&action=updatestatus">
            ...
            <button type="button" class="btn btn-xs btn-danger btn-flat show_confirm2" data-toggle="tooltip" test="ไม่อนุมัติ" test2="<?php echo "$Requestforteacherlist->student_name" ;?>"  title='Delete'>ไม่อนุมัติ</button>
        </form>
    </td>
    </tr>
    <?php
