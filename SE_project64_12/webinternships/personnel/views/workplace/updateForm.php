...
<form method="POST"  action="?controller=workplace&action=update" enctype="multipart/form-data" >
<div id="main">
...
<div class="block-1">
<br>
  <h2 style="position: relative;left:50px">แก้ไขข้อมูลสถานที่ประกอบการ</h2>
  <br>

    <div class="row">
        <div class="col">
            <div class="col-25" style="position: relative;left:50px">ชื่อสถานประกอบการ/หน่วยงาน</div>
            <input type="text" name="name_workp" style="position: relative;left:50px" 
              value="<?php echo $workplaceList->name_workp;?>" required/>
              <div class="invalid-feedback" style="position: relative;left:50px"  >
                    กรุณาระบุสถานที่ประกอบการ
                  </div>
        </div>
    </div>
    <div class="row">
          <div class="col">
            ...
            <div class="col-75"><textarea type="text2" name="detail_workp" style="position: relative;left:50px" required><?php echo $workplaceList->detail_workp;?></textarea></div>
          </div>
    </div>
    <div class="row">
          <div class="col">
            <div class="col-25" style="position: relative;left:50px">ที่อยู่สถานที่ประกอบการ</div>
            <div class="col-75"><textarea type="text2" name="add_workp" style="position: relative;left:50px" required><?php echo $workplaceList->add_workp;?></textarea></div>
          </div>
    </div>
    <div class="row">
        <div class="col">
            <div class="col-25" style="position: relative;left:50px">ค่าตอบแทน</div>
            <div class="col-75"><input type="text" name="money_workp" style="position: relative;left:50px"
            value="<?php echo $workplaceList->money_workp;?>" required/></div>
        </div>
    </div>
    <br>
    <div class="row">
        <div class="col">
              <input type="hidden"name="oldid"value="<?php echo $workplaceList->id_workp; ?>"/>
              <button type="submit" class = "btn btn-xs btn-primary"  style="position: relative;top:25px;left:500px" name="action" value="addintrequest" >อัพเดต</button>
              </form>
        </div>
        <div class="col">
...
$(function(){
     $("#myform2").on("submit",function(){
        ...
        {
          if (confirm("ยืนยันการอัพเดตสถานที่?")) {
          } else {
            event.preventDefault();
          event.stopPropagation();
          }
