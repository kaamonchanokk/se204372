...
<div class="block-1">
<br>
  <h2 style="position: relative;left:50px">อัพโหลดเอกสารฝึกงาน</h2>
  <br>
  <form method="POST" action="?controller=document&action=adddocument" enctype="multipart/form-data" >
    <div class="row">
        <div class="col">
            <div class="col-25" style="position: relative;left:50px">วันที่เพิ่มเอกสาร</div>
            <div class="col-75"><p name="date_doc"style="position: relative;left:50px"><?php echo date("Y-m-d"); ?><p>
            <input name="date_doc" type="hidden" value="<?php echo date("Y-m-d"); ?>">   </div>
        </div>
    </div>
    <br>
    ...
    <div class="row">
        <div class="col">
            ...
            <div class="col-75"><input type="text" name="name_doc" style="position: relative;left:50px" required/></div>
        </div>
    </div>
    <br>
    ...
    <div class="row">
        <div class="col">
            <div class="col-25" style="position: relative;left:50px">อัพโหลดไฟล์(.pdf)</div>
            <div class="col-75"><input type="file" name="file_doc" value="" style="position: relative;left:50px;" required/></div>
        </div>
    </div>
