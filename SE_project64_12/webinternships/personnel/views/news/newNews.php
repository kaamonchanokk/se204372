...
<div class="block-1">
<br>
  <h2 style="position: relative;left:50px">เพิ่มข่าวสาร</h2>
  <br>
  <form method="POST" action="?controller=news&action=addnews" enctype="multipart/form-data" >
    <div class="row">
        <div class="col">
            <div class="col-25" style="position: relative;left:50px">วันที่เพิ่มข่าว</div>
            <div class="col-75"><p name="date_news"style="position: relative;left:50px"><?php echo date("Y-m-d"); ?><p>
            <input name="date_news" type="hidden" value="<?php echo date("Y-m-d"); ?>">   </div>
        </div>
    </div>
    <br>
    ...
    <div class="row">
        <div class="col">
            ...
            <div class="col-75"><input type="text" name="name_news" style="position: relative;left:50px" required/></div>
        </div>
    </div>
    <br>
    ...
    <div class="row">
        <div class="col">
            ...
            <div class="col-75"><textarea type="text2" name="detail_news" style="position: relative;left:50px" required></textarea></div><br>
        </div>
    </div>
    <br>
    ...
    <div class="row">
        <div class="col">
            <div class="col-25" style="position: relative;left:50px">อัพโหลดไฟล์ภาพ(.jpg,.png.jpeg)</div>
            <div class="col-75"><input type="file" name="file_news" value="" style="position: relative;left:50px;" required/></div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col">
              <button type="submit" class = "btn btn-primary btn-xs"  style="position: relative;top:25px;left:500px" name="action">เพิ่มข้อมูล</button>
              </form>
        </div>
        <div class="col">
