...
<div class="block-1">
<br>
  <h2 style="position: relative;left:50px">แก้ไขข่าวสาร</h2>
  <br>
  <form method="POST" action="?controller=news&action=update" enctype="multipart/form-data" >
    <div class="row">
        <div class="col">
            <div class="col-25" style="position: relative;left:50px">วันที่อัพเดตข่าว(ล่าสุด)</div>
            <div class="col-75"><p style="position: relative;left:50px"><?php echo $Newslist->date_news;?></p></div>
        </div>
        <div class="col">
            <div class="col-25" style="position: relative;left:50px">วันที่อัพเดตข่าวปัจจุปัน</div>
            <div class="col-75"><p style="position: relative;left:50px"><?php echo date("Y-m-d");?></p></div>
            <input name="date_news" type="hidden" value="<?php echo date("Y-m-d"); ?>">
          </div>
    </div>
    <br>
    ...
    <div class="row">
        <div class="col">
            <div class="col-25" style="position: relative;left:50px">หัวข้อ</div>
            <div class="col-75"><input type="text" name="name_news" style="position: relative;left:50px"
            value="<?php echo $Newslist->name_news;?>" required/></div>
        </div>
    </div>
    <br>
    ...
    <div class="row">
        <div class="col">
            <div class="col-25" style="position: relative;left:50px">รายละเอียด</div>
            <div class="col-75"><textarea type="text2" name="detail_news" style="position: relative;left:50px" required><?php echo $Newslist->detail_news;?></textarea></div><br>
        </div>
    </div>
    <br>
    ...
    <!--<div class="row">
        <div class="col">
            <div class="col-25" style="position: relative;left:50px">อัพโหลดไฟล์ภาพ</div>
            <div class="col-75"><input type="file" name="file_news" style="position: relative;left:50px;"
            value="http://localhost/webinternships/SE/imagenews/<?php echo "$Newslist->file_news" ;?>"/></div>
        </div>
    </div>-->
    ...
    <div class="row">
        <div class="col">
              <input type="hidden"name="id_news"value="<?php echo $Newslist->id_news; ?>"/>
              <button type="submit" class = "btn btn-primary btn-xs"  style="position: relative;top:25px;left:500px" name="action" value="addintrequest" >อัพเดต</button>
              </form>
        </div>
        <div class="col">
