...
class intpresent
{
    ...
    public static function get($student_id)
    {
        ...
        $sql="SELECT * FROM int_present NATURAL JOIN student Left JOIN staff ON int_present.staff_id = staff.staff_id WHERE student_id='$student_id' ORDER BY date_intpre";
        ...
        $list[] = new intpresent($id_intpre,$date_intpre,$place_intpre,$a_intpre,$file_intpre,
        $status_intpre,$year_intpre,$student_id,$student_name,$student_year,$staff_id,$staff_name);
        }
    ...
    public static function Add($date_intpre,$student_id,$place_intpre,$a_intpre,$file_intpre,$year_intpre)
    { 
       require("connection_connect.php");
       $sql = "INSERT INTO `int_present` (`id_intpre`, `date_intpre`, `student_id`, `place_intpre`
       , `file_intpre`, `a_intpre`, `status_intpre`, `year_intpre`, `staff_id`) VALUES (NULL,'$date_intpre','$student_id','$place_intpre','$file_intpre','$a_intpre','รออนุมัติ','$year_intpre',NULL)";
       $result = $conn->query($sql);
       require("connection_close.php");
       return  ;
    }
